...
import { ProductEntity } from "../../src/entities/product.entity"; // Ruta correcta
import { ProductTypeEntity } from "../../src/entities/productType.entity";// Asegúrate de que esta ruta sea correcta
